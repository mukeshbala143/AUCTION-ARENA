...
const FEATS = [
  ...
  ['🤖','Claude AI Analysis','Post-auction squad rankings with strengths, best XI, predictions.'],
  ...
  return (
    <div className="min-h-screen bg-bg relative">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20">
        ...
        {/* Stats bar */}
        <div className="flex mt-14 overflow-hidden rounded-2xl anim-5" style={{border:'0.5px solid rgba(255,255,255,0.07)',background:'rgba(255,255,255,0.02)'}}>
          {[['350+','IPL Players'],['10','Teams Max'],['15s','Bid Timer'],['3','Sport Arenas'],['AI','Post-Analysis']].map(([v,l],i,a)=>(
            <div key={l} className="px-8 py-4 text-center" style={{borderRight:i<a.length-1?'0.5px solid rgba(255,255,255,0.07)':'none'}}>
      ...
      {/* SPORTS */}
      <section id="sports" className="relative z-10 max-w-7xl mx-auto px-8 py-24">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-8 pb-16">
        <div className="rounded-3xl p-16 text-center relative overflow-hidden" style={{background:'#13131f',border:'0.5px solid rgba(242,166,35,0.15)'}}>
          ...
          <div className="flex gap-3 max-w-sm mx-auto mb-8 relative z-10">
            <input value={code} onChange={e=>setCode(e.target.value.toUpperCase())} onKeyDown={e=>e.key==='Enter'&&join()}
                   className="aa-input flex-1 text-center font-mono text-xl tracking-[6px] uppercase" maxLength={6} placeholder="AX94KL"
                   style={{fontSize:'1.1rem',letterSpacing:'0.4em'}}/>
