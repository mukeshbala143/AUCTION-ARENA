  ...
  return (
    <div className="min-h-screen bg-bg relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 pt-24 pb-12">
        ...
        <h1 className="font-bebas text-5xl tracking-[3px] mb-1 anim-2">Create Your <span className="text-gold">Auction Room</span></h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-8 items-start">
          ...
          <div className="space-y-5">
            {/* Sport selector */}
            <div className="surface p-6 anim-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                {SPORTS.map(s=>(
                  <button key={s.id} onClick={()=>setSport(s.id)}
                          className="relative py-5 px-4 rounded-xl transition-all text-center"
            ...
            {/* Teams & Purse */}
            <div className="surface p-6 anim-4">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <select className="aa-select" value={teams} onChange={e=>setTeams(+e.target.value)}>
                ...
                <div>
                  ...
                  <input type="range" min={50} max={200} step={5} value={purse} onChange={e=>setPurse(+e.target.value)}/>
            ...
            <div className="surface p-6 anim-4">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <input type="range" min={10} max={30} step={1} value={squad} onChange={e=>setSquad(+e.target.value)}/>
                ...
                <div>
                  ...
                  <input type="range" min={4} max={11} step={1} value={overseas} onChange={e=>setOverseas(+e.target.value)}/>
            ...
            {/* Player order */}
            <div className="surface p-6 anim-5">
              ...
              <div className="grid grid-cols-2 gap-3">
                {[['shuffled','🎲','Shuffled (Random)','All players randomised at auction start. Maximum unpredictability.'],
                  ...
                  <button key={v} onClick={()=>setOrder(v)} className="text-left p-4 rounded-xl transition-all"
                    ...
                    <p className="text-xs text-muted leading-relaxed ml-5">{desc}</p>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="surface p-6 anim-5">
              ...
              <input className="aa-input" value={roomName} onChange={e=>setRoomName(e.target.value)} placeholder="e.g. Friday Night Auction, IPL Fantasy 2026…" maxLength={40}/>
