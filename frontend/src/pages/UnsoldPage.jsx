      ...
      <div className="flex-1 flex flex-col md:flex-row gap-0 relative z-10" style={{minHeight:0}}>
          ...
          {teams.map((t, i) => {
            ...
            return (
              <div key={t.id} className="rounded-xl flex-shrink-0 overflow-hidden transition-all duration-300"
                ...
                <div className={`transition-all duration-300 ease-in-out ${expandedTeam === t.id ? 'max-h-64 opacity-100' : 'max-h-0 opacity-0'} overflow-y-auto custom-scrollbar`}>
                  {t.picks && t.picks.length > 0 ? (
                    <div className="px-3 pb-3 pt-1 flex flex-col gap-1" style={{background:'rgba(0,0,0,0.15)', borderTop:'0.5px solid rgba(255,255,255,0.03)'}}>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="hidden md:flex flex-shrink-0 px-4 py-3 items-center gap-4"
               style={{borderBottom:'0.5px solid rgba(255,255,255,0.07)',background:'rgba(7,7,14,0.9)'}}>
